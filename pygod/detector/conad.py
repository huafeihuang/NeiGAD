...
class CONAD(DeepDetector):
    ...
    **kwargs : optional
    ...
    def _data_augmentation(self, data):
        ...
        edges_mask = edges_mask.to(adj_aug.device)
        ...
        inv_idx = torch.zeros(num_nodes, dtype=torch.int64).to(edge_index_aug.device)
        inv_idx[node_idx] = torch.arange(batch_size).to(edge_index_aug.device)
