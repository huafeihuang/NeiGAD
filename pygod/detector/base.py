...
class Detector(ABC):
    ...
    def _predict_prob(self, score, method='linear'): # linear = minmax scale
...
class DeepDetector(Detector, ABC):
    ...
    **kwargs
    ...
    def __init__(self,
        ...
        self.best_decision_score_ = None
        self.roc_auc = 0.0
        self.best_epoch = -1
        self.y = None
    ...
    def fit(self, data, label=None):
        ...
        # print('self.batch_size:',self.batch_size) # full graph num
        ...
        self.model.train() 
        self.decision_score_ = torch.zeros(data.x.shape[0]) # update score
        for epoch in range(self.epoch):
            ...
            for sampled_data in loader:
                ...
                # print('batch_size: ',batch_size) # batch_size 64 but all node
                node_idx = sampled_data.n_id

                loss, score = self.forward_model(sampled_data) # get score
