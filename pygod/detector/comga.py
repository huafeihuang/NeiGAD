...
class ComGA(Detector):
    ...
    def fit(self, G: Data, y=None):
        ...
        for epoch in range(1, self.epoch + 1):
            ...
            if self.eval_mode:
                temp_roc_auc = eval_roc_auc(self.y, self.decision_score_)
                if temp_roc_auc > self.roc_auc:
                    self.roc_auc = temp_roc_auc
                    self.best_decision_score_ = self.decision_score_
